...
if("TRUE" STREQUAL "TRUE")
  set(programming_2_SOURCE_PREFIX /home/marcoarruda/Desktop/sematron_ros/sematron_ws/src/programming_2)
  set(programming_2_DEVEL_PREFIX /home/marcoarruda/Desktop/sematron_ros/sematron_ws/devel)
  ...
  set(programming_2_INSTALL_PREFIX /home/marcoarruda/Desktop/sematron_ros/sematron_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'programming_2' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marcoarruda/Desktop/sematron_ros/sematron_ws/src/programming_2/${idir}'.  Ask the maintainer 'marcoarruda <marcoarruda@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${programming_2_dep}_FOUND)
      find_package(${programming_2_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${programming_2_dep} REQUIRED ${depend_list})
  endif()

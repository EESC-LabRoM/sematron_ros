...
if("TRUE" STREQUAL "TRUE")
  set(programming_3_SOURCE_PREFIX /home/marcoarruda/Desktop/sematron_ros/sematron_ws/src/programming_3)
  set(programming_3_DEVEL_PREFIX /home/marcoarruda/Desktop/sematron_ros/sematron_ws/devel)
  ...
  set(programming_3_INSTALL_PREFIX /home/marcoarruda/Desktop/sematron_ros/sematron_ws/install)
...
if(NOT "/home/marcoarruda/Desktop/sematron_ros/sematron_ws/src/programming_3/include " STREQUAL " ")
  set(programming_3_INCLUDE_DIRS "")
  set(_include_dirs "/home/marcoarruda/Desktop/sematron_ros/sematron_ws/src/programming_3/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'programming_3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/marcoarruda/Desktop/sematron_ros/sematron_ws/src/programming_3/${idir}'.  Ask the maintainer 'marcoarruda <marcoarruda@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${programming_3_dep}_FOUND)
      find_package(${programming_3_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${programming_3_dep} REQUIRED ${depend_list})
  endif()

...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'programming_3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/victor/sematron_ros/sematron_ws/install/${idir}'.  Ask the maintainer 'marcoarruda <marcoarruda@todo.todo>' to fix it.")
    endif()
